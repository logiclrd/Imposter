...
namespace Imposter.Tests.Features.Docs.Methods.UseBaseImplementation
{
    ...
    public sealed class MyServiceImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.Docs.Methods.UseBaseImplementation.MyService>
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // virtual int MyService.MightFail(int v)
        public interface IMightFailMethodImposterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<MightFailInvocationVerifier>, IMightFailMethodInvocationImposterGroup, IMightFailMethodInvocationImposterGroupCallback
        {
        }
        ...
        internal class MightFailMethodImposter
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<MightFailInvocationVerifier>, IMightFailMethodImposterBuilder, IMightFailMethodInvocationImposterGroupContinuation
            {
                ...
                class HaveBeenCalledProxy : MightFailInvocationVerifier
                {
                    MightFailMethodImposter.Builder _owner;
                    internal HaveBeenCalledProxy(MightFailMethodImposter.Builder owner)
                    {
                        _owner = owner;
                    }

                    void MightFailInvocationVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // virtual Task MyService.ProcessAsync(string s)
        public interface IProcessAsyncMethodImposterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<ProcessAsyncInvocationVerifier>, IProcessAsyncMethodInvocationImposterGroup, IProcessAsyncMethodInvocationImposterGroupCallback
        {
        }
        ...
        internal class ProcessAsyncMethodImposter
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<ProcessAsyncInvocationVerifier>, IProcessAsyncMethodImposterBuilder, IProcessAsyncMethodInvocationImposterGroupContinuation
            {
                ...
                class HaveBeenCalledProxy : ProcessAsyncInvocationVerifier
                {
                    ProcessAsyncMethodImposter.Builder _owner;
                    internal HaveBeenCalledProxy(ProcessAsyncMethodImposter.Builder owner)
                    {
                        _owner = owner;
                    }

                    void ProcessAsyncInvocationVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
