...
namespace Imposter.Tests.Features.ClassImpersonation.Suts
{
    ...
    public sealed class ClassWithOverloadsAndGenericsImposter : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.ClassImpersonation.Suts.ClassWithOverloadsAndGenerics>
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // virtual T ClassWithOverloadsAndGenerics.Echo<T>(T item)
        public interface IEchoMethodImposterBuilder<T> : global::Imposter.Abstractions.IHaveInvocationVerifier<EchoInvocationVerifier<T>>, IEchoMethodInvocationImposterGroup<T>, IEchoMethodInvocationImposterGroupCallback<T>
        {
        }
        ...
        internal class EchoMethodImposter<T> : IEchoMethodImposter<T>
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<EchoInvocationVerifier<T>>, IEchoMethodImposterBuilder<T>, IEchoMethodInvocationImposterGroupContinuation<T>
            {
                ...
                class HaveBeenCalledProxy : EchoInvocationVerifier<T>
                {
                    EchoMethodImposter<T>.Builder _owner;
                    internal HaveBeenCalledProxy(EchoMethodImposter<T>.Builder owner)
                    {
                        _owner = owner;
                    }

                    void EchoInvocationVerifier<T>.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // virtual string ClassWithOverloadsAndGenerics.Format(string value, int padding)
        public interface IFormat_1MethodImposterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<Format_1InvocationVerifier>, IFormat_1MethodInvocationImposterGroup, IFormat_1MethodInvocationImposterGroupCallback
        {
        }
        ...
        internal class Format_1MethodImposter
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<Format_1InvocationVerifier>, IFormat_1MethodImposterBuilder, IFormat_1MethodInvocationImposterGroupContinuation
            {
                ...
                class HaveBeenCalledProxy : Format_1InvocationVerifier
                {
                    Format_1MethodImposter.Builder _owner;
                    internal HaveBeenCalledProxy(Format_1MethodImposter.Builder owner)
                    {
                        _owner = owner;
                    }

                    void Format_1InvocationVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // virtual TFirst ClassWithOverloadsAndGenerics.SelectFirst<TFirst, TSecond>(TFirst first, TSecond second)
        public interface ISelectFirstMethodImposterBuilder<TFirst, TSecond> : global::Imposter.Abstractions.IHaveInvocationVerifier<SelectFirstInvocationVerifier<TFirst, TSecond>>, ISelectFirstMethodInvocationImposterGroup<TFirst, TSecond>, ISelectFirstMethodInvocationImposterGroupCallback<TFirst, TSecond>
        {
        }
        ...
        internal class SelectFirstMethodImposter<TFirst, TSecond> : ISelectFirstMethodImposter<TFirst, TSecond>
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<SelectFirstInvocationVerifier<TFirst, TSecond>>, ISelectFirstMethodImposterBuilder<TFirst, TSecond>, ISelectFirstMethodInvocationImposterGroupContinuation<TFirst, TSecond>
            {
                ...
                class HaveBeenCalledProxy : SelectFirstInvocationVerifier<TFirst, TSecond>
                {
                    SelectFirstMethodImposter<TFirst, TSecond>.Builder _owner;
                    internal HaveBeenCalledProxy(SelectFirstMethodImposter<TFirst, TSecond>.Builder owner)
                    {
                        _owner = owner;
                    }

                    void SelectFirstInvocationVerifier<TFirst, TSecond>.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
