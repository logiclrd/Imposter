    ...
    public sealed class IHaveIndexerImposter<T> : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.OpenGenericImposter.IHaveIndexer<T>> where T : class
    {
        ...
        internal class Indexer_2IndexerBuilder
        {
            ...
            private sealed class GetterImposter
            {
                ...
                private void HaveBeenCalled(Indexer_2IndexerArgumentsCriteria criteria, global::Imposter.Abstractions.Count count)
                {
                    int invocationCount = _invocationHistory.Count(criteria.Matches);
                    if (!count.Matches(invocationCount))
                    {
                ...
                [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
                internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<IIndexer_2IndexerGetterVerifier>, IIndexer_2IndexerGetterBuilder, IIndexer_2IndexerGetterFluentBuilder
                {
                    private readonly GetterImposter _imposter;
                    private readonly Indexer_2IndexerArgumentsCriteria _criteria;
                    ...
                    class HaveBeenCalledProxy : IIndexer_2IndexerGetterVerifier
                    {
                        Builder _owner;
                        internal HaveBeenCalledProxy(Builder owner)
                        {
                        ...
                        void IIndexer_2IndexerGetterVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                    }
            ...
            private sealed class SetterImposter
            {
                ...
                public void HaveBeenCalled(Indexer_2IndexerArgumentsCriteria criteria, global::Imposter.Abstractions.Count count)
                {
                    int invocationCount = _invocationHistory.Count(entry => criteria.Matches(entry.Arguments));
                    if (!count.Matches(invocationCount))
                    {
                ...
                [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
                internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<IIndexer_2IndexerSetterVerifier>, IIndexer_2IndexerSetterBuilder, IIndexer_2IndexerSetterFluentBuilder
                {
                    private readonly SetterImposter _setterImposter;
                    private readonly Indexer_2IndexerArgumentsCriteria _criteria;
                    ...
                    class HaveBeenCalledProxy : IIndexer_2IndexerSetterVerifier
                    {
                        Builder _owner;
                        internal HaveBeenCalledProxy(Builder owner)
                        {
                        ...
                        void IIndexer_2IndexerSetterVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                    }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        public interface IIndexer_2IndexerGetterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<IIndexer_2IndexerGetterVerifier>, IIndexer_2IndexerGetterOutcomeBuilder, IIndexer_2IndexerGetterCallbackBuilder
        {
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        public interface IIndexer_2IndexerSetterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<IIndexer_2IndexerSetterVerifier>, IIndexer_2IndexerSetterCallbackBuilder
        {
        }
