...
namespace Imposter.Tests.Features.OpenGenericImposter
{
    ...
    public sealed class IOpenGenericWithMethodGenericsImposter<T> : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.OpenGenericImposter.IOpenGenericWithMethodGenerics<T>>
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // void IOpenGenericWithMethodGenerics<T>.DoSomething<TArg>(TArg arg)
        public interface IDoSomethingMethodImposterBuilder<TArg> : global::Imposter.Abstractions.IHaveInvocationVerifier<DoSomethingInvocationVerifier<TArg>>, IDoSomethingMethodInvocationImposterGroup<TArg>, IDoSomethingMethodInvocationImposterGroupCallback<TArg>
        {
        }
        ...
        internal class DoSomethingMethodImposter<TArg> : IDoSomethingMethodImposter<TArg>
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<DoSomethingInvocationVerifier<TArg>>, IDoSomethingMethodImposterBuilder<TArg>, IDoSomethingMethodInvocationImposterGroupContinuation<TArg>
            {
                ...
                class HaveBeenCalledProxy : DoSomethingInvocationVerifier<TArg>
                {
                    DoSomethingMethodImposter<TArg>.Builder _owner;
                    internal HaveBeenCalledProxy(DoSomethingMethodImposter<TArg>.Builder owner)
                    {
                        _owner = owner;
                    }

                    void DoSomethingInvocationVerifier<TArg>.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // TResult IOpenGenericWithMethodGenerics<T>.Map<TSource, TResult>(TSource source)
        public interface IMapMethodImposterBuilder<TSource, TResult> : global::Imposter.Abstractions.IHaveInvocationVerifier<MapInvocationVerifier<TSource, TResult>>, IMapMethodInvocationImposterGroup<TSource, TResult>, IMapMethodInvocationImposterGroupCallback<TSource, TResult>
        {
        }
        ...
        internal class MapMethodImposter<TSource, TResult> : IMapMethodImposter<TSource, TResult>
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<MapInvocationVerifier<TSource, TResult>>, IMapMethodImposterBuilder<TSource, TResult>, IMapMethodInvocationImposterGroupContinuation<TSource, TResult>
            {
                ...
                class HaveBeenCalledProxy : MapInvocationVerifier<TSource, TResult>
                {
                    MapMethodImposter<TSource, TResult>.Builder _owner;
                    internal HaveBeenCalledProxy(MapMethodImposter<TSource, TResult>.Builder owner)
                    {
                        _owner = owner;
                    }

                    void MapInvocationVerifier<TSource, TResult>.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // TArg IOpenGenericWithMethodGenerics<T>.Transform<TArg>(T input)
        public interface ITransformMethodImposterBuilder<TArg> : global::Imposter.Abstractions.IHaveInvocationVerifier<TransformInvocationVerifier<TArg>>, ITransformMethodInvocationImposterGroup<TArg>, ITransformMethodInvocationImposterGroupCallback<TArg>
        {
        }
        ...
        internal class TransformMethodImposter<TArg> : ITransformMethodImposter<TArg>
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<TransformInvocationVerifier<TArg>>, ITransformMethodImposterBuilder<TArg>, ITransformMethodInvocationImposterGroupContinuation<TArg>
            {
                ...
                class HaveBeenCalledProxy : TransformInvocationVerifier<TArg>
                {
                    TransformMethodImposter<TArg>.Builder _owner;
                    internal HaveBeenCalledProxy(TransformMethodImposter<TArg>.Builder owner)
                    {
                        _owner = owner;
                    }

                    void TransformInvocationVerifier<TArg>.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
