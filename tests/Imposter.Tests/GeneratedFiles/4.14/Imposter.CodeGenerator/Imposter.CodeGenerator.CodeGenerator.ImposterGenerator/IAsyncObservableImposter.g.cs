...
namespace Imposter.Tests.Features.OpenGenericImposter
{
    ...
    public sealed class IAsyncObservableImposter<T> : global::Imposter.Abstractions.IHaveImposterInstance<global::Imposter.Tests.Features.OpenGenericImposter.IAsyncObservable<T>>
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
        // void IAsyncObservable<T>.OnNext(T item)
        public interface IOnNextMethodImposterBuilder : global::Imposter.Abstractions.IHaveInvocationVerifier<OnNextInvocationVerifier>, IOnNextMethodInvocationImposterGroup, IOnNextMethodInvocationImposterGroupCallback
        {
        }
        ...
        internal class OnNextMethodImposter
        {
            ...
            [global::System.CodeDom.Compiler.GeneratedCode("Imposter.CodeGenerator", "0.1.0.0")]
            internal class Builder : global::Imposter.Abstractions.HaveInvocationVerifier<OnNextInvocationVerifier>, IOnNextMethodImposterBuilder, IOnNextMethodInvocationImposterGroupContinuation
            {
                ...
                class HaveBeenCalledProxy : OnNextInvocationVerifier
                {
                    OnNextMethodImposter.Builder _owner;
                    internal HaveBeenCalledProxy(OnNextMethodImposter.Builder owner)
                    {
                        _owner = owner;
                    }

                    void OnNextInvocationVerifier.HaveBeenCalled(global::Imposter.Abstractions.Count count) => _owner.HaveBeenCalled(count);
                }
            }
        }
